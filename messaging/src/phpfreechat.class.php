...
class phpFreeChat
{
  ...
  function printChat( $return = false )
  {
    ...
    {
      $output .= "<p>phpChat cannot be initialized, please correct these errors:</p><ul>";
  ...
  function &loadScripts($theme, &$xml_reponse)
  {
    ...
    $labels_to_load =
      array( "Do you really want to leave this room ?", // _pfc
             ...
             "Mail", // _pfc
             "Color", // _pfc
             "Drive CHAT [powered by Blaze Enterprises-%s]", // _pfc
             ...
             "Drive Chat current version is %s", // _pfc
