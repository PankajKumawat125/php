...
<B><font face="monotype corsiva" size="5%"color="silver"><br>
    <div style="height:300px;width:40%;float:left;"><a href="/php/signup.php"><img src="/php/images/picture2.png" onmouseover="this.src = '/php/images/signupbutton.gif'" onmouseout="this.src = '/php/images/Picture2.png'" height=="200px" width="400px"/></a>
