...
<?php include'css.css'; ?>
    ...
    <div align="center"><font color="#BCC6CC" size=5>
        <h2><b>We need your Password  and Email ID to recover your UserName.</b><br><br>
            This protects your account from unauthorised access.
            </font></h2>
        <fieldset style="width:0%;" align="left">
            <legend style="color:red;font-weight:bold"><b><font face="timesnew roman" color="#5F9EA0" size=5><u>Recover UserName</u> :</font></b></legend>
            <table width="500" height="120" cellpadding="1" cellspacing="1" style="background-color:#463E3F;">
                <form action="nextu1.php" method="POST">
                    <tr><td>Enter Password :</td>
                        <td><input type="password" name="password"  placeholder="Password" size="40" maxlength="100" class="" tabindex="1">
                        </td></tr>
