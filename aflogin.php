...
<?php	
		$query2		= "select * from signup where uname = '".$_SESSION['login_user']."'";
        ...
        <tbody>
            <?php
				...
				?>
                        ...
                        <td width="10%">
                            <div align ="center">
                                <a href="download.php?filename=<?php echo $row['uploads']; ?>"><input type = "button" name="download" value="Download" /></a>
                            </div>
                        </td> 
						<?php
					}
					?>
						...
						<td width="10%">
							...
							?>
							 ...
							 <input type = "submit" name="Request" value="Request" /></form>
								<?php 
								}
							?>
                            </div>
